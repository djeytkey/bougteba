...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('/gain', 'HomeController@gains');
	...
	Route::post('sales/add_discount', 'SaleController@addDiscount')->name('sale.add-discount');
	Route::get('sales/getsales/{id}', 'SaleController@getSales');
	...
	Route::post('sales/exportbyselection', 'SaleController@exportBySelection');
	Route::post('sales/returnexportbyselection', 'SaleController@returnexportBySelection');
	Route::post('sales/senddeliverybyselection', 'SaleController@senddeliveryBySelection');
	...
	Route::post('sales/export-data', 'SaleController@exportData');
	Route::resource('sales', 'SaleController');

	Route::post('withdraw/facture/{id}', 'WithdrawalController@factureView')->name('withdraw.facture');
	Route::get('withdraw/facturation', 'WithdrawalController@facturation')->name('withdraw.facturation');
	Route::post('withdraw/facturationbyselection', 'WithdrawalController@facturationBySelection');
	Route::post('withdraw/unfacturationbyselection', 'WithdrawalController@unfacturationBySelection');
	Route::post('withdraw/paybyselection', 'WithdrawalController@payBySelection');
	Route::post('withdraw/paidbyselection', 'WithdrawalController@paidBySelection');
	Route::post('withdraw/demander-retrait/{id}', 'WithdrawalController@demanderRetrait')->name('withdraw.demander-retrait');
	Route::get('withdraw/demandes-retrait', 'WithdrawalController@demandesRetrait')->name('withdraw.demandes-retrait');
	Route::post('withdraw/virementbyselection', 'WithdrawalController@virementBySelection');
	Route::post('withdraw/facturation-data', 'WithdrawalController@facturationData');
	Route::post('withdraw/withdraw-data', 'WithdrawalController@withdrawData');
	Route::post('withdraw/demande-data', 'WithdrawalController@demandeData');
	Route::get('withdraw/gen_invoice/{id}', 'WithdrawalController@genInvoice')->name('withdraw.invoice');
	Route::resource('withdraw', 'WithdrawalController');

	Route::post('referral/facturation-data', 'ReferralController@facturationData');
	Route::post('referral/referral-data', 'ReferralController@referralwData');
	Route::post('referral/paybyselection', 'ReferralController@payBySelection');
	Route::get('referral/facturation', 'ReferralController@facturation')->name('referral.facturation');
	Route::post('referral/referral-data', 'ReferralController@referralData');
	Route::get('referral/gen_invoice/{id}', 'ReferralController@genInvoice')->name('referral.invoice');
	Route::post('referral/paidbyselection', 'ReferralController@paidBySelection');
	Route::post('referral/virementbyselection', 'ReferralController@virementBySelection');
	Route::resource('referral','ReferralController');

	Route::get('delivery', 'DeliveryController@index')->name('delivery.index');
	Route::post('delivery/delivery-data', 'DeliveryController@deliveryData');
	Route::get('delivery/product_delivery/{id}','DeliveryController@productDeliveryData');
	Route::get('delivery/delivery_status/{id}','DeliveryController@DeliveryStatus');
	...
	Route::post('user/add_refferal', 'UserController@addReferral')->name('user.add-refferal');
	...
	Route::get('impersonate/destroy', 'ImpersonateController@destroy')->name('impersonate.destroy');
    ...
    Route::post('tickets/close/{id}', 'TicketsController@close');
	...
	Route::get('gain-process', 'DevClearCacheController@gain_process')->name('gain-process');
});

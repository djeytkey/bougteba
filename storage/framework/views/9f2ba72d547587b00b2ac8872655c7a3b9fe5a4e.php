        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6 mt-5" id="product-variant-warehouse-section">
                    <h5 style="text-align: center;"><?php echo e(trans('file.Product Quantity')); ?></h5>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        htmltext = slidertext = '';
        var user_role = "<?php echo e($role->id); ?>";

        if (user_role == '1') {
            htmltext = '<table class="table modal-table table-bordered"><tr class="d-none"><td><strong><?php echo e(trans("file.Type")); ?>: </strong></td><td>'+product[0]+'</td></tr><tr><td><strong><?php echo e(trans("file.name")); ?>: </strong></td><td>'+product[1]+'</td></tr><tr><td><strong><?php echo e(trans("file.Code")); ?>: </strong></td><td>'+product[2]+'</td></tr><tr class="d-none"><td><strong><?php echo e(trans("file.Brand")); ?>: </strong></td><td>'+product[3]+'</td></tr><tr><td><strong><?php echo e(trans("file.category")); ?>: </strong></td><td>'+product[4]+'</td></tr><tr><td><strong><?php echo e(trans("file.Quantity")); ?>: </strong></td><td>'+product[16]+'</td></tr><tr><td><strong><?php echo e(trans("file.Unit")); ?>: </strong></td><td>'+product[5]+'</td></tr><tr><td><strong><?php echo e(trans("file.Cost")); ?>: </strong></td><td>'+product[6]+'</td></tr><tr><td><strong><?php echo e(trans("file.Price")); ?>: </strong></td><td>'+product[7]+'</td></tr><tr class="d-none"><td><strong><?php echo e(trans("file.Tax")); ?>: </strong></td><td>'+product[8]+'</td></tr><tr class="d-none"><td><strong><?php echo e(trans("file.Tax Method")); ?> : </strong></td><td>'+product[9]+'</td></tr><tr><td><strong><?php echo e(trans("file.Alert Quantity")); ?> : </strong></td><td>'+product[10]+'</td></tr><tr><td><strong><?php echo e(trans("file.Product Details")); ?>: </strong></td><td>'+product[11]+'</td></tr></table>';
        } else {
            htmltext = '<table class="table modal-table table-bordered"><tr><td><strong><?php echo e(trans("file.name")); ?>: </strong></td><td>'+product[1]+'</td></tr><tr><td><strong><?php echo e(trans("file.Code")); ?>: </strong></td><td>'+product[2]+'</td></tr><tr><td><strong><?php echo e(trans("file.Brand")); ?>: </strong></td><td>'+product[3]+'</td></tr><tr><td><strong><?php echo e(trans("file.category")); ?>: </strong></td><td>'+product[4]+'</td></tr><tr><td><strong><?php echo e(trans("file.Quantity")); ?>: </strong></td><td>'+product[16]+'</td></tr><tr><td><strong><?php echo e(trans("file.Unit")); ?>: </strong></td><td>'+product[5]+'</td></tr><tr><td><strong><?php echo e(trans("file.Price")); ?>: </strong></td><td>'+product[7]+'</td></tr><tr><td><strong><?php echo e(trans("file.Product Details")); ?>: </strong></td><td>'+product[11]+'</td></tr></table>';
        }
        ...
        if(product[0] == 'combo') {
            ...
            $.get('products/product_warehouse/' + product[12], function(data) {
                ...
                if(data.product_variant_warehouse[0].length != 0) {
                    ...
                    color = data.product_variant_warehouse[2];
                    var newHead = $("<thead>");
                    var newBody = $("<tbody>");
                    var newRow = $("<tr>");
                    newRow.append('<th colspan="3" style="text-align: center;"><?php echo e(trans("file.Product Quantity")); ?></th></tr><tr><th><?php echo e(trans("file.Variant")); ?></th><th><?php echo e(trans("file.Quantity")); ?></th><th><?php echo e(trans("file.Color")); ?></th></tr>');
                    newHead.append(newRow);
                    $.each(variant, function(index){
                        var newRow = $("<tr>");
                        var cols = '';
                        cols += '<td style="text-align: center;">' + variant[index] + '</td>';
                        cols += '<td style="text-align: center;">' + qty[index] + '</td>';
                        cols += '<td style="text-align: center;"><i class="fa-solid fa-square" style="background-color: ' + color[index] + '; color: ' + color[index] + '; width: 24px; border-radius: 5px;"></i></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/product/index.blade.php ENDPATH**/ ?>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <h3><strong><?php echo e($lims_sale_data->reference_no); ?></strong></h3>
                                            <input type="hidden" name="reference_no" value="<?php echo e($lims_sale_data->reference_no); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.customer')); ?> *</label>
                                            <input type="text" name="customer_name" id="customer_name" class="form-control" value="<?php echo e($lims_sale_data->customer_name); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Phone Number')); ?> *</label>
                                            <input type="tel" pattern="0[0-9]{9}" name="customer_tel" id="customer_tel" class="form-control" value="<?php echo e($lims_sale_data->customer_tel); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.City')); ?> *</label>
                                            <input type="hidden" name="city_id_hidden" value="<?php echo e($lims_sale_data->customer_city); ?>" />
                                            <select required name="customer_city" id="customer_city" class="selectpicker form-control" data-live-search="true" title="Select City...">
                                                <?php $__currentLoopData = $lims_city_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="customer_address" id="customer_address" rows="3" class="form-control"><?php echo e($lims_sale_data->customer_address); ?></textarea>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('file.Original Price')); ?></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="original_price"><?php echo e(number_format((float)$product_sale->original_price, 2, '.', ' ')); ?> </td>
                                ...
                                <div class="row mt-3" style="display: none">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="order_discount" id="order_discount" class="form-control" value="<?php echo e($lims_sale_data->order_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php if($lims_sale_data->is_valide): ?>
                                            <input class="mt-2" type="checkbox" name="is_valide" id="is_valide" value="1" checked>
                                            <?php else: ?>
                                            <input class="mt-2" type="checkbox" name="is_valide" id="is_valide" value="1">
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#customer_address").keydown(function(e){
            if (e.keyCode == 51) {
                e.preventDefault();
            }
        });
    ...
    //assigning value
    $('select[name="customer_city"]').val($('input[name="city_id_hidden"]').val());
    ...
    var id = $('input[name="city_id_hidden"]').val();
    ...
    $('#lims_productcodeSearch').on('input', function(){
        ...
        if(!customer_name){
            ...
            alert('<?php echo e(trans('file.Please fill customer name !')); ?>');
        }
        else if(!customer_tel){
            $('#lims_productcodeSearch').val(temp_data.substring(0, temp_data.length - 1));        
            alert('<?php echo e(trans('file.Please fill customer telephone !')); ?>');
        }
        else if(!customer_city){
            $('#lims_productcodeSearch').val(temp_data.substring(0, temp_data.length - 1));        
            alert('<?php echo e(trans('file.Please select customer city !')); ?>');
        }
        else if(!customer_address){
            $('#lims_productcodeSearch').val(temp_data.substring(0, temp_data.length - 1));        
            alert('<?php echo e(trans('file.Please fill customer address !')); ?>');
        }
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    var discount_value = parseFloat($("#order_discount").val());
                    var discount_original = parseFloat(data[2] * discount_value / 100);
                    var discounted_original = parseFloat(data[2]) - parseFloat(discount_original);
                    cols += '<td>' + data[0] + '<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button></td>';
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td><input type="number" class="form-control qty" name="qty[]" value="1" step="any" required/></td>';
                    cols += '<td class="original_price">' + Number(discounted_original).toFixed(2) + '</td>';
                    // if(data[12]) {
                    ...
                    cols += '<input type="hidden" class="original_price" name="original_price[]" value="' + discounted_original + '"/>';
    ...
    function calculateGrandTotal() {
        ...
        var grand_total = subtotal + order_tax + shipping_cost;
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/sale/edit.blade.php ENDPATH**/ ?>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(trans('file.Delivery List')); ?></h3>
            </div>
            <?php echo Form::open(['route' => 'delivery.index', 'method' => 'get']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            <select id="status_id" name="status_id" class="selectpicker form-control" data-live-search="true" >
                                <option value="0"><?php echo e(trans('file.All Status')); ?></option>
        ...
        <a href="<?php echo e(url('sales/export')); ?>" class="btn btn-primary"><i class="dripicons-list"></i> <?php echo e(trans('file.Export List')); ?></a>
        <?php endif; ?>
    </div>
        ...
        <table id="delivery-table" class="table sale-list stripe" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th class="not-exported"><?php echo e(trans('file.Facturation')); ?></th>
...
<script type="text/javascript">
    ...
    $('#delivery-table').DataTable( {
        ...
        buttons: [
            /*{
                text: '<?php echo e(trans("file.Export")); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/delivery/index.blade.php ENDPATH**/ ?>
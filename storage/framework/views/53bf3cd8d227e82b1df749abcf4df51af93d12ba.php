                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered permission-table role-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo e(trans('file.Purchase Paiements')); ?></td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        <?php if(in_array('purchases-view-paiement', $all_permission)): ?>
                                                            <input type="checkbox" value="1" id="purchases-view-paiement"
                                                                name="purchases-view-paiement" checked>
                                                        <?php else: ?>
                                                            <input type="checkbox" value="1" id="purchases-view-paiement"
                                                                name="purchases-view-paiement">
                                                        <?php endif; ?>
                                                        <label for="purchases-view-paiement"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        <?php if(in_array('purchases-add-paiement', $all_permission)): ?>
                                                            <input type="checkbox" value="1" id="purchases-add-paiement"
                                                                name="purchases-add-paiement" checked>
                                                        <?php else: ?>
                                                            <input type="checkbox" value="1" id="purchases-add-paiement"
                                                                name="purchases-add-paiement">
                                                        <?php endif; ?>
                                                        <label for="purchases-add-paiement"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        <?php if(in_array('purchases-edit-paiement', $all_permission)): ?>
                                                            <input type="checkbox" value="1" id="purchases-edit-paiement"
                                                                name="purchases-edit-paiement" checked />
                                                        <?php else: ?>
                                                            <input type="checkbox" value="1" id="purchases-edit-paiement"
                                                                name="purchases-edit-paiement">
                                                        <?php endif; ?>
                                                        <label for="purchases-edit-paiement"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        <?php if(in_array('purchases-delete-paiement', $all_permission)): ?>
                                                            <input type="checkbox" value="1" id="purchases-delete-paiement"
                                                                name="purchases-delete-paiement" checked>
                                                        <?php else: ?>
                                                            <input type="checkbox" value="1" id="purchases-delete-paiement"
                                                                name="purchases-delete-paiement">
                                                        <?php endif; ?>
                                                        <label for="purchases-delete-paiement"></label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        <?php if(in_array('sales-gen-invoice', $all_permission)): ?>
                                                            <input type="checkbox" value="1" id="sales-gen-invoice"
                                                                name="sales-gen-invoice" checked>
                                                        <?php else: ?>
                                                            <input type="checkbox" value="1" id="sales-gen-invoice"
                                                                name="sales-gen-invoice">
                                                        <?php endif; ?>
                                                        <label for="sales-gen-invoice"><?php echo e(trans('file.Generate invoice')); ?></label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        <?php if(in_array('expenses-export', $all_permission)): ?>
                                                            <input type="checkbox" value="1" id="expenses-export"
                                                                name="expenses-export" checked>
                                                        <?php else: ?>
                                                            <input type="checkbox" value="1" id="expenses-export"
                                                                name="expenses-export">
                                                        <?php endif; ?>
                                                        <label for="expenses-export"></label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bota2375/app.bougteba.com/resources/views/role/permission.blade.php ENDPATH**/ ?>
...
<section class="no-search">
    <div class="container-fluid">
        <div class="card">
            ...
            <?php echo Form::open(['route' => 'withdraw.facturation', 'method' => 'get']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            <select id="status_id" name="status_id" class="selectpicker form-control" data-live-search="true" >
                                <option value="0"><?php echo e(trans('file.Non Payée')); ?></option>
                                <option value="1"><?php echo e(trans('file.Facturée')); ?></option>
                                <option value="2"><?php echo e(trans('file.Validée')); ?></option>                                
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <table id="facturation-table" class="table facturation-list stripe" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Remise')); ?></th>
...
<script type="text/javascript">
    ...
    $('#facturation-table').DataTable( {
        ...
        buttons: [
            ...
            {
                text: '<?php echo e(trans("file.Valider")); ?>',
            ...
            {
                text: '<?php echo e(trans("file.Dévalider")); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/withdraw/facturation.blade.php ENDPATH**/ ?>
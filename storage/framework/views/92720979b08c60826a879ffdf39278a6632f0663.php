                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo e(asset('public/images/product/'.$image)); ?>" height="60" width="60">
                                        ...
                                        <table id="variant-table" class="table table-hover variant-list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo e(trans('file.Color')); ?></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input readonly type="text" class="form-control" name="variant_name[]" value="<?php echo e($variant->name); ?>" /></td>
                                                    <td><input readonly type="text" class="form-control" name="item_code[]" value="<?php echo e($variant->pivot['item_code']); ?>" /></td>
                                                    <td><div class="input-group colorpicker-class"><input name="variant_color[]" type="text" class="form-control" value="<?php echo e($variant->pivot['variant_color']); ?>"><div class="input-group-append"><span class="input-group-text"><i class="fa-solid fa-square" style="background-color: <?php echo e($variant->pivot['variant_color']); ?>; color: <?php echo e($variant->pivot['variant_color']); ?>; width: 24px; border-radius: 5px;"></i></i></span></div></div></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.colorpicker-class').on('colorpickerChange', function(event) {
            $(this).children().children().children('i').css({
                'background-color': event.color.toString(),
    ...
    $("input[name='variant']").on("input", function () {
        if($("#code").val() == ''){
            ...
            cols += '<td><input readonly type="text" class="form-control" name="variant_name[]" value="' + variant_name + '" /></td>';
            cols += '<td><input readonly type="text" class="form-control" name="item_code[]" value="'+item_code+'" /></td>';
            cols += '<td><div class="input-group colorpicker-class"><input name="variant_color[]" type="text" class="form-control" value="#000000"><div class="input-group-append"><span class="input-group-text"><i class="fa-solid fa-square" style="background-color: #000000; color: #000000; width: 24px; border-radius: 5px;"></i></i></span></div></div></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/product/edit.blade.php ENDPATH**/ ?>
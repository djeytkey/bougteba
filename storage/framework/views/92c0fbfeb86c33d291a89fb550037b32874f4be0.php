...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.colorpicker-class').on('colorpickerChange', function(event) {
            $('.colorpicker-class .fa-square').css('color', event.color.toString());
        });
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/product/create.blade.php ENDPATH**/ ?>
        ...
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <?php if(session()->has('error')): ?>
              <div class="alert alert-danger alert-dismissible text-center mt-3"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo session()->get('error'); ?></div> 
            <?php endif; ?>
...
</script><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/auth/login.blade.php ENDPATH**/ ?>
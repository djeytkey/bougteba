            ...
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    <li><a href="#dashboard" aria-expanded="false" data-toggle="collapse"> <i
                                class="dripicons-meter"></i><span><?php echo e(__('file.dashboard')); ?></span><span></a>
                        <ul id="dashboard" class="collapse list-unstyled ">
                            <li id="dashboard-1"><a href="<?php echo e(url('/')); ?>"><?php echo e(__('file.Dashboard 1')); ?></a>
                            </li>
                            <li id="dashboard-2"><a href="<?php echo e(url('/gain')); ?>"><?php echo e(__('file.Dashboard 2')); ?></a>
                            </li>
                        </ul>
                    </li>
                    <?php
                            ...
                            <ul id="withdraw" class="collapse list-unstyled ">
                                ...
                                <?php if($withdraw_invoicing_permission_active): ?>
                                    <li id="withdraw-facturation-menu">
                                        <a
                                            href="<?php echo e(route('withdraw.facturation')); ?>"><?php echo e(trans('file.Facturation')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($add_permission_active): ?>
                                    <li>
                                        <a id="demande-retrait" href="" data-toggle="modal"
                                            data-target="#withdraw-modal"> <?php echo e(trans('file.Demander Un Retrait')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($withdraw_requests_permission_active): ?>
                                    <li id="withdraw-demandes-menu">
                                        <a
                                            href="<?php echo e(route('withdraw.demandes-retrait')); ?>"><?php echo e(trans('file.Demandes de retrait')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                            ...
                            <ul id="referral" class="collapse list-unstyled ">
                                ...
                                <?php if($referral_invoicing_permission_active): ?>
                                    <li id="referral-facturation-menu">
                                        <a
                                            href="<?php echo e(route('referral.facturation')); ?>"><?php echo e(trans('file.Facturation')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($add_referral_permission_active): ?>
                                    <li>
                                        <a id="add-referral" href="" data-toggle="modal"
                                            data-target="#referral-modal"> <?php echo e(trans('file.Add Referral')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
...
<?php /**PATH D:\laragon\www\bougteba\resources\views/layout/main.blade.php ENDPATH**/ ?>
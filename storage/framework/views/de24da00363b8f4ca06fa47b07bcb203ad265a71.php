                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Minimim Withdraw')); ?> *</label>
                                        <input type="number" min="0" name="min_withdraw" class="form-control" value="<?php if($lims_general_setting_data): ?><?php echo e($lims_general_setting_data->min_withdraw); ?><?php endif; ?>" required />
                                    </div>
                                </div>       
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Montant parrainage')); ?> *</label>
                                        <input type="number" min="0" name="referral" class="form-control" value="<?php if($lims_general_setting_data): ?><?php echo e($lims_general_setting_data->referral); ?><?php endif; ?>" required />
                                    </div>
                                </div>       
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/setting/general_setting.blade.php ENDPATH**/ ?>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(trans('file.Export List')); ?></h3>
                ...
                <a href="<?php echo e(route('sales.index')); ?>" class="btn btn-success"><i class="dripicons-list"></i> <?php echo e(trans('file.Sales List')); ?></a>&nbsp;
                <a href="<?php echo e(route('delivery.index')); ?>" class="btn btn-primary"><i class="dripicons-rocket"></i> <?php echo e(trans('file.Delivery List')); ?></a>
                <?php endif; ?>
            </div>
                ...
                <table id="export-table" class="table sale-list stripe" style="width: 100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(trans('file.Remark')); ?></th>
                            <th><?php echo e(trans('file.Qty')); ?></th>
                            <th class="not-exported"><?php echo e(trans('file.Status')); ?></th>  
                            <th class="not-exported"><?php echo e(trans('file.Delivery Status')); ?></th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    ...
    var tableExport = $('#export-table').DataTable( {
        ...
        buttons: [            
            {
                text: '<?php echo e(trans("file.Send Delivery")); ?>',
            ...
            {
                extend: 'excel',
                text: '<?php echo e(trans("file.Excel")); ?>',
            ...
            {
                text: '<?php echo e(trans("file.Cancel Export")); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/sale/export.blade.php ENDPATH**/ ?>
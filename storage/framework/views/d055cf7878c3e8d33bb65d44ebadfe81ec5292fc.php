        ...
        <table id="user-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($user->id); ?>">
                    ...
                    <td><?php echo e(number_format($user->discount, 2, '.', ' ')); ?> %</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <?php if($user->is_active): ?>
                                <li>
                                	<a href="<?php echo e(route('impersonate', $user->id)); ?>" class="btn btn-link"><i class="dripicons-swap"></i> Connect</a>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/user/index.blade.php ENDPATH**/ ?>
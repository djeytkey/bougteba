                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Reference No')); ?> <span class="required">*</span></label>
                                            <h3><strong><?php echo e(strtolower(Auth::user()->name) . '-' . date("dmy") . '-'. date("His")); ?></strong></h3>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.customer')); ?> <span class="required">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Phone Number')); ?> <span class="required">*</span></label>
                                            <input type="tel" pattern="0[0-9]{9}" name="customer_tel" id="customer_tel" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.City')); ?> <span class="required">*</span></label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <label><?php echo e(trans('file.Address')); ?> <span class="required">*</span></label>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <h5><?php echo e(trans('file.Order Table')); ?> <span class="required">*</span></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="livraison" value="<?php echo e($lims_general_setting_data->livraison); ?>"/>
                                ...
                                <div class="row mt-3" style="display: none">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="order_discount" class="form-control" value="<?php echo e(Auth::user()->discount); ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    var discount_original = parseFloat(data[2] * data[13] / 100);
                    var discounted_original = parseFloat(data[2]) - parseFloat(discount_original);
                    cols += '<td>' + data[0] + '<button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button></td>';
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td><input type="number" class="form-control qty" name="qty[]" value="1" step="any" required/></td>';
                    cols += '<td class="original_price tarikkkk">' + Number(discounted_original).toFixed(2) + '</td>';
                    ...
                    // cols += '<td class="discount">' + Number(discount_original).toFixed(2) + '</td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/sale/create.blade.php ENDPATH**/ ?>
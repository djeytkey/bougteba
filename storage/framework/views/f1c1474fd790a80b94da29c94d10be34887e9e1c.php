    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(trans('file.Withdraw List')); ?></h3>
            </div>
            <?php echo Form::open(['route' => 'withdraw.index', 'method' => 'get']); ?>
        ...
        <table id="withdraw-table" class="table withdraw-list stripe" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Sales Number')); ?></th>
                    <th><?php echo e(trans('file.Sales Reference No')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/withdraw/index.blade.php ENDPATH**/ ?>
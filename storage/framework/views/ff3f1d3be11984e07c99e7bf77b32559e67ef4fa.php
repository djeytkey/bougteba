                            ...
                            <div class="row mb-5">
                                <div class="col-sm-7 invoice-col mb-5">
                                    <?php if($general_setting->site_logo): ?>
                                        <img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="150"
                                            style="margin:10px 0;">
                                    <?php endif; ?>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-5 invoice-col">
                                    ...
                                    ?>
                                    <h5><b>Facture N° : <?php echo e($lims_fact_data->facture_no); ?></b></h5><br>
                                    <table style="width: 100%">
                                        <tr>
                                            <td><b><?php echo e(strtoupper($user->last_name)); ?>&nbsp;<?php echo e(strtoupper($user->first_name)); ?></b></td>
                                            <td rowspan="3">
                                                <?php if($lims_fact_data->status == 1): ?>
                                                <img src="<?php echo e(asset('public/images/paid.png')); ?>" alt="paid" width="100" />
                                                <?php else: ?>
                                                <img src="<?php echo e(asset('public/images/virement.png')); ?>" alt="virement" width="100" />
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Date : </b><?php echo e($date_fact); ?></td>
                                        </tr>
                                        <tr>
                                            <td><b>Heure : </b><?php echo e($heure_fact); ?></td>
                                        </tr>
                                    </table> 
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td><?php echo e($total_cde); ?></td>
                                            </tr>
                                            <tr>
                                                <th>Total Commandes</th>
                                                <td><?php echo e(number_format((float)$grand_total_total, 2, '.', ' ')); ?> DHS</td>
                                            </tr>
                                            <tr>
                                                <th>Total Remises</th>
                                                <td><?php echo e(number_format((float)$total_discount_total, 2, '.', ' ')); ?> DHS</td>
                                            </tr>
                                            <tr>
                                                <th>Total Prix Original</th>
                                                <td><?php echo e(number_format((float)$original_price_total, 2, '.', ' ')); ?> DHS</td>
                                            </tr>
                                            <tr>
                                                <th>Total Livraison</th>
                                                <td><?php echo e(number_format((float)$livraison_total, 2, '.', ' ')); ?> DHS</td>
                                            </tr>
                                            <tr>
                                                <th>Total Bénifice</th>
                                                <td style="color: red;"><b><?php echo e(number_format((float)$gain_total, 2, '.', ' ')); ?> DHS</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
<?php /**PATH /home/jbgz9206/public_html/magasinette.ma/resources/views/withdraw/invoice.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('public/logo/favicon.png', '')); ?>" />
            ...
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    $add_permission_active = DB::table('role_has_permissions')
                        ...
                        ->first();
                    ?>
                    <?php if($index_permission_active || $add_permission_active): ?>
                    ...
                    $delivery_index_permission_active = DB::table('role_has_permissions')
                        ...
                        ->first();
                    ?>
                    <?php if($sale_index_permission_active || $sale_add_permission_active || $add_discount_permission_active || $export_index_permission_active || $delivery_index_permission_active): ?>
                        <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="sale" class="collapse list-unstyled ">
                                ...
                                <?php endif; ?>
                                <?php if($add_discount_permission_active): ?>
                                    <li><a id="add-discount" href="" data-toggle="modal"
                                            data-target="#discount-modal"> <?php echo e(trans('file.Add Discount')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($export_index_permission_active): ?>
                                    <li id="export-menu"><a
                                            href="<?php echo e(route('sales.export')); ?>"><?php echo e(trans('file.Export List')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($delivery_index_permission_active): ?>
                    ...
                    $withdraw_requests_permission_active = DB::table('role_has_permissions')
                        ...
                        ->first();
                    ?>
                    <?php if($withdraw_index_permission_active || $withdraw_invoicing_permission_active || $withdraw_requests_permission_active): ?>
                        <li><a href="#withdraw" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="withdraw" class="collapse list-unstyled ">
                                <?php if($withdraw_index_permission_active): ?>
                                    <li id="withdraw-list-menu">
                                        <a href="<?php echo e(route('withdraw.index')); ?>"><?php echo e(trans('file.Withdraw List')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php
                                $add_permission = DB::table('permissions')
                                ...
                                $add_permission_active = DB::table('role_has_permissions')
                                    ...
                                    ->first();
                                ?>
                                <?php if($withdraw_invoicing_permission_active): ?>
                                    <li id="withdraw-facturation-menu">
                                        <a href="<?php echo e(route('withdraw.facturation')); ?>"><?php echo e(trans('file.Facturation')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($add_permission_active): ?>
                                    <li>
                                        <a id="demande-retrait" href="" data-toggle="modal" data-target="#withdraw-modal"> <?php echo e(trans('file.Demander Un Retrait')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($withdraw_requests_permission_active): ?>
                                    <li id="withdraw-demandes-menu">
                                        <a href="<?php echo e(route('withdraw.demandes-retrait')); ?>"><?php echo e(trans('file.Demandes de retrait')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    $add_referral_permission_active = DB::table('role_has_permissions')
                        ...
                        ->first();
                    ?>
                    <?php if($referral_index_permission_active || $referral_invoicing_permission_active || $add_referral_permission_active): ?>
                        <li><a href="#referral" aria-expanded="false" data-toggle="collapse"> <i
                                    class="dripicons-card"></i><span><?php echo e(trans('file.Referral')); ?></span></a>
                            <ul id="referral" class="collapse list-unstyled ">
                                <?php if($referral_index_permission_active): ?>
                                    <li id="referral-list-menu">
                                        <a href="<?php echo e(route('referral.index')); ?>"><?php echo e(trans('file.Referral List')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($referral_invoicing_permission_active): ?>
                                    <li id="referral-facturation-menu">
                                        <a href="<?php echo e(route('referral.facturation')); ?>"><?php echo e(trans('file.Facturation')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($add_referral_permission_active): ?>
                                    <li>
                                        <a id="add-referral" href="" data-toggle="modal" data-target="#referral-modal"> <?php echo e(trans('file.Add Referral')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    <li class=""><a href="#ticket" aria-expanded="false" data-toggle="collapse"> <i
                                class="dripicons-briefcase"></i><span><?php echo e(trans('file.Tickets')); ?></span></a>
                        <ul id="ticket" class="collapse list-unstyled ">
                            
                            <li id="ticket-list-menu"><a
                                    href="<?php echo e(route('tickets.index')); ?>"><?php echo e(trans('file.Ticket List')); ?></a>
                            </li>
                            <li><a id="add-ticket" href=""><?php echo e(trans('file.Add Ticket')); ?></a></li>
                    ...
                    <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
                        ...
                        <ul id="setting" class="collapse list-unstyled ">
                            ...
                            <?php if($unit_permission_active): ?>
                                <li id="unit-menu"><a
                                        href="<?php echo e(route('unit.index')); ?>"><?php echo e(trans('file.Unit')); ?></a>
                                </li>
                            <?php endif; ?>
                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big">
                        <?php if($general_setting->site_logo): ?>
                            <a href="<?php echo e(url('/')); ?>"><img
                                    src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="90"></a>
                        <?php else: ?>
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('impersonate')): ?>
                            <li class="nav-item"><a href="<?php echo e(route('impersonate.destroy')); ?>"><i
                        ...
                        <?php if($backup_database_permission_active): ?>
                            <li>
                                <a href="<?php echo e(route('setting.backup')); ?>"><i class="dripicons-archive"></i>
                                    <?php echo e(trans('file.Backup Database')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if(Auth::user()->role_id == 1): ?>
                            <li>
                                <a href="<?php echo e(route('clear-views')); ?>"><i class="dripicons-lock"></i>
                                    <?php echo e(trans('file.Clear Views')); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('clear-cache')); ?>"><i class="dripicons-lock-open"></i>
                                    <?php echo e(trans('file.Clear Cache')); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('gain-process')); ?>"><i class="dripicons-article"></i>
                                    <?php echo e(trans('file.Gain Table')); ?></a>
                            </li>
                        <?php endif; ?>
    ...
    <div class="page">
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Demander un retrait')); ?></h5>
                    ...
                    <div class="modal-body">
                        ...
                        ?>
                        <?php if($total_gains >= $lims_min_retrait->min_withdraw): ?>
                            <?php if(!$lims_retrait_data->demande_r): ?>
                                <?php if($diff > 30): ?>
                                    <p style="text-align: center;">
                                        <?php echo e(trans('file.Confirmer votre demande de retrait ? ')); ?></p>
                                    <p style="text-align: center;">
                                        <?php echo e(trans('file.Le montant total des gains  : ')); ?> <b
                                            style="color: red;"><?php echo e(number_format((float) $total_gains, 2, '.', ' ')); ?>

                                            DHS</b></p>
                                    <?php echo Form::open(['route' => ['withdraw.demander-retrait', 'id' => Auth::id()], 'method' => 'post']); ?>
                                ...
                                <?php else: ?>
                                    <p style="text-align: center;"><?php echo e(trans('file.Il vous reste')); ?> <b
                                            style="color: red;"><?php echo e(31 - $diff); ?> <?php echo e(trans('file.jours')); ?></b>
                                        <?php echo e(trans('file.avant de demander un retrait !')); ?></p>
                                <?php endif; ?>
                            <?php else: ?>
                        ...
                        <?php else: ?>
                            <p style="text-align: center;">
                                <?php echo e(trans('file.Le montant total des gains doit être supérieur ou égal à : ')); ?> <b
                                    style="color: red;"><?php echo e(number_format((float) $lims_min_retrait->min_withdraw, 2, '.', ' ')); ?>

                                    DHS</b></p>
                            <p style="text-align: center;"><?php echo e(trans('file.Vous avez : ')); ?> <b
                                    style="color: red;"><?php echo e(number_format((float) $total_gains, 2, '.', ' ')); ?>
        ...
        <div id="discount-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Add Discount')); ?></h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <?php echo Form::open(['route' => 'sale.add-discount', 'method' => 'post']); ?>
                                ...
                                <select name="discount_user_id" class="selectpicker form-control" required
                                    ...
                                    <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>">
                                            <?php echo e(strtoupper($user->last_name) . ' ' . ucfirst($user->first_name) . ' (' . $user->name . ')'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 form-group">
                                <label><?php echo e(trans('file.Montant de la remise')); ?> *</label>
        ...
        <div id="facturation-referral-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Facturation pour ')); ?> <span
        ...
        <div id="referral-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Add Referral')); ?></h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <?php echo Form::open(['route' => 'user.add-refferal', 'method' => 'post']); ?>
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div class="col-md-6 col-sm-12 form-group">
                                <label><?php echo e(trans('file.Vendeur')); ?> *</label>
                                <select name="referral_user_id" class="selectpicker form-control" required
                                    data-live-search="true" title="<?php echo e(trans('file.Select saler...')); ?>">
                                    <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>">
                                            <?php echo e(strtoupper($user->last_name) . ' ' . ucfirst($user->first_name) . ' (' . $user->name . ')'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 form-group">
                                <label><?php echo e(trans('file.Referral')); ?> *</label>
                                <select name="referral_id" class="selectpicker form-control" required
                                    data-live-search="true" title="<?php echo e(trans('file.Select referral...')); ?>">
                                    <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>">
                                            <?php echo e(strtoupper($user->last_name) . ' ' . ucfirst($user->first_name) . ' (' . $user->name . ')'); ?>
        ...
        <div id="ticket-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Add Ticket')); ?></h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <?php echo Form::open(['route' => 'tickets.store', 'method' => 'post']); ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" method="POST">
                                            ...
                                            <div
                                                class="form-group<?php echo e($errors->has('priority') ? ' has-error' : ' '); ?><?php echo e($errors->has('priority') ? ' has-error' : ' '); ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="selectpicker form-control" required data-live-search="true"
                                ...
                                <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>">
                                        <?php echo e($user->name . ' (' . $user->phone . ')'); ?>
...
<?php /**PATH /home/bota2375/app.bougteba.com/resources/views/layout/main.blade.php ENDPATH**/ ?>
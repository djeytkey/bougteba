        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6 mt-5" id="product-variant-warehouse-section">
                    <h5 style="text-align: center;">{{trans('file.Product Quantity')}}</h5>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        if (user_role == '1') {
            htmltext = '<table class="table modal-table table-bordered"><tr class="d-none"><td><strong>{{trans("file.Type")}}: </strong></td><td>'+product[0]+'</td></tr><tr><td><strong>{{trans("file.name")}}: </strong></td><td>'+product[1]+'</td></tr><tr><td><strong>{{trans("file.Code")}}: </strong></td><td>'+product[2]+'</td></tr><tr class="d-none"><td><strong>{{trans("file.Brand")}}: </strong></td><td>'+product[3]+'</td></tr><tr><td><strong>{{trans("file.category")}}: </strong></td><td>'+product[4]+'</td></tr><tr><td><strong>{{trans("file.Quantity")}}: </strong></td><td>'+product[16]+'</td></tr><tr><td><strong>{{trans("file.Unit")}}: </strong></td><td>'+product[5]+'</td></tr><tr><td><strong>{{trans("file.Cost")}}: </strong></td><td>'+product[6]+'</td></tr><tr><td><strong>{{trans("file.Price")}}: </strong></td><td>'+product[7]+'</td></tr><tr class="d-none"><td><strong>{{trans("file.Tax")}}: </strong></td><td>'+product[8]+'</td></tr><tr class="d-none"><td><strong>{{trans("file.Tax Method")}} : </strong></td><td>'+product[9]+'</td></tr><tr><td><strong>{{trans("file.Alert Quantity")}} : </strong></td><td>'+product[10]+'</td></tr><tr><td><strong>{{trans("file.Product Details")}}: </strong></td><td>'+product[11]+'</td></tr></table>';
        } else {
            htmltext = '<table class="table modal-table table-bordered"><tr><td><strong>{{trans("file.name")}}: </strong></td><td>'+product[1]+'</td></tr><tr><td><strong>{{trans("file.Code")}}: </strong></td><td>'+product[2]+'</td></tr><tr><td><strong>{{trans("file.Brand")}}: </strong></td><td>'+product[3]+'</td></tr><tr><td><strong>{{trans("file.category")}}: </strong></td><td>'+product[4]+'</td></tr><tr><td><strong>{{trans("file.Quantity")}}: </strong></td><td>'+product[16]+'</td></tr><tr><td><strong>{{trans("file.Unit")}}: </strong></td><td>'+product[5]+'</td></tr><tr><td><strong>{{trans("file.Price")}}: </strong></td><td>'+product[7]+'</td></tr><tr><td><strong>{{trans("file.Product Details")}}: </strong></td><td>'+product[11]+'</td></tr></table>';
        }
        ...
        if(product[0] == 'combo') {
            ...
            $.get('products/product_warehouse/' + product[12], function(data) {
                ...
                if(data.product_variant_warehouse[0].length != 0) {
                    ...
                    var newBody = $("<tbody>");
                    var newRow = $("<tr>");
                    newRow.append('<th colspan="3" style="text-align: center;">{{trans("file.Product Quantity")}}</th></tr><tr><th>{{trans("file.Variant")}}</th><th>{{trans("file.Quantity")}}</th><th>{{trans("file.Color")}}</th></tr>');
                    newHead.append(newRow);
